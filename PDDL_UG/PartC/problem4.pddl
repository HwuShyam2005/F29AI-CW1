(define (problem windfarm-mission-4)
  ...
  ;  {engineer1 - engineer} IS THE ENGINEER.
  ...
  ;  THE ENGINEER STARTS AT THE BAY FIRST.
  ;  WAYPOINT1 - WAYPOINT2
  ;  WAYPOINT2 - WAYPOINT1
  ;  WAYPOINT2 - WAYPOINT3
  ;  WAYPOINT2 - WAYPOINT4
  ...
  ;  ENGINEER MUST BE PRESENT AT THE CONTROL CENTRE. 
  ;  DATA FROM UUV1 MUST BE SENT TO SHIP1. 
  ;  DATA FROM UUV2 MUST BE SENT TO SHIP2.
         (transmitted_data uuv1 ship1)
         (transmitted_data uuv2 ship2)
      )
   )
)